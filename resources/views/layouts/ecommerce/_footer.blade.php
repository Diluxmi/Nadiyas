                ...
                <div class="col-sm-6 col-lg-4 my-3">
                    ...
                    <address class="white-link mb-4">
                        <p class="text-white text-opacity-85 mb-2">Nadiyas,
                            ...
                            <p class="mb-2"><a class="border-bottom border-secondary" href="tel:820-885-3321">054-2222143</a></p></address>
                    ...
                    <div class="col-sm-6 col-lg-2 my-3">
                        ...
                        <ul class="list-unstyled white-link footer-link-1 m-0">
                            ...
                            </li><li class="pb-2"><a href="#">Shipping</a></li>
                            <li class="pb-2"><a href="#">Return</a></li></ul>
                        </div>
                        <div class="col-sm-6 col-lg-4 my-3">
